...
/* function myFunction(value, index, array) {
    // console.table([value, index, array]);
    console.log(value);
    console.log(index);
    console.log(array);
    console.log("------------------------------")
...
//     console.log("----------");
//     return total + value;
//     // return total + (value * value) // square
// }
...
/* // array indexOf
const newNumbers = numbers.indexOf(25);

console.log(newNumbers); */


/* // array lastIndexOf
const newNumbers = numbers.lastIndexOf(25);

console.log(newNumbers); */


/* // array includes
const newNumbers = numbers.includes(25);
...
// array keys
const newNumbers = numbers.keys();

console.log(newNumbers);

let text = "";
for (let x of newNumbers) {
    text += x + "<br>";
}
console.log(text);
...
// arraytest = [3, 4]; // uncaught type error: assignment to constant variable
